...
public class Functional_1 {
	 ...
	 * by 2.
	 *
	 * doubling([1, 2, 3]) → [2, 4, 6] doubling([6, 8, 6, 8, -1]) → [12, 16, 12,
	 * 16, -2] doubling([]) → []
	 */
	 ...
	 * with itself.
	 *
	 * square([1, 2, 3]) → [1, 4, 9] square([6, 8, -6, -8, 1]) → [36, 64, 36,
	 * 64, 1] square([]) → []
	 */
	 ...
	 * copies3(["24", "a", ""]) → ["242424", "aaa", ""] copies3(["hello",
	 * "there"]) → ["hellohellohello", "theretherethere"]
	 */
	 ...
	 * 
	 * math1([1, 2, 3]) → [20, 30, 40] math1([6, 8, 6, 8, 1]) → [70, 90, 70, 90,
	 * 20] math1([10]) → [110]
	 */
	 ...
	 * 
	 * rightDigit([1, 22, 93]) → [1, 2, 3] rightDigit([16, 8, 886, 8, 1]) → [6,
	 * 8, 6, 8, 1] rightDigit([10, 0]) → [0, 0]
	 */
