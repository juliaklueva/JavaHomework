...
public class Map_1 {
	 ...
	 * mapBully({"a": "candy"}) → {"a": "", "b": "candy"} mapBully({"a":
	 * "candy", "b": "carrot", "c": "meh"}) → {"a": "", "b": "candy", "c":
	 * "meh"}
	 */
	 ...
	 * mapShare({"b": "xyz", "c": "ccc"}) → {"b": "xyz"} mapShare({"a": "aaa",
	 * "c": "meh", "d": "hi"}) → {"a": "aaa", "b": "aaa", "d": "hi"}
	 */
	 ...
	 * 
	 * mapAB({"a": "Hi", "b": "There"}) → {"a": "Hi", "ab": "HiThere", "b":
	 ...
	 * "cherry"} topping1({}) → {"bread": "butter"} topping1({"pancake":
	 * "syrup"}) → {"bread": "butter", "pancake": "syrup"}
	 */
	 ...
	 * "cherry"} topping2({"spinach": "dirt", "ice cream": "cherry"}) →
	 ...
	 * the key "spinach".
	 * 
	 * topping3({"potato": "ketchup"}) → {"potato": "ketchup", "fries":
	 * "ketchup"} topping3({"potato": "butter"}) → {"potato": "butter", "fries":
	 * "butter"} topping3({"salad": "oil", "potato": "ketchup"}) → {"spinach":
	 * "oil", "salad": "oil", "potato": "ketchup", "fries": "ketchup"}
	 */
	 ...
	 * mapAB2({"a": "aaa", "b": "bbb"}) → {"a": "aaa", "b": "bbb"} mapAB2({"a":
	 * "aaa", "b": "bbb", "c": "aaa"}) → {"a": "aaa", "b": "bbb", "c": "aaa"}
	 */
	 ...
	 * mapAB3({"a": "aaa", "b": "bbb", "c": "cake"}) → {"a": "aaa", "b": "bbb",
	 * "c": "cake"}
	 */
	 ...
	 * 
	 * mapAB4({"a": "aaa", "b": "bb", "c": "cake"}) → {"a": "aaa", "b": "bb",
	 * "c": "aaa"} mapAB4({"a": "aa", "b": "bbb", "c": "cake"}) → {"a": "aa",
	 * "b": "bbb", "c": "bbb"} mapAB4({"a": "aa", "b": "bbb"}) → {"a": "aa",
	 * "b": "bbb", "c": "bbb"}
	 */
