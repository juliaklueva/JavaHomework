...
public class Logic_1 {
	...
	public boolean in1To10(int n, boolean outsideMode) {
		return !outsideMode && n <= 10 && n >= 1 || outsideMode && (n >= 10 || n <= 1);
	}
	 ...
	 * is special. Use the % "mod" operator -- see <a
	 ...
	 * Less20
	 *
	 * Return true if the given non-negative number is 1 or 2 <b>less</b> than a
	 ...
	 * will the remainder be when one number divides evenly into another? (See
	 * also: <a href=/doc/practice/fizzbuzz-code.html>FizzBuzz Code</a> and <a
	 * href=/doc/practice/mod-introduction.html>Introduction to Mod</a>)
	 *
	 ...
	 *
	 * inOrder(1, 2, 4, false) -> true inOrder(1, 2, 1, false) -> false
	 ...
	 * 7 or 5 5 5.
	 *
	 * inOrderEqual(2, 5, 11, false) -> true inOrderEqual(5, 7, 6, false) ->
	 ...
	 *
	 * lastDigit(23, 19, 13) -> true lastDigit(23, 19, 12) -> false
	 ...
	 *
	 * blueTicket(9, 1, 0) -> 10 blueTicket(9, 2, 0) -> 0 blueTicket(6, 1, 4) ->
	 * 10
	 */
	...
	public int sumLimit(int a, int b) {
		...
		int sumDigit = String.valueOf(a + b).length();
		return (sumDigit > aDigit) ? a : a + b;
	}
