...
public class Functional_2 {
	 ...
	 * 
	 * no9([1, 2, 19]) → [1, 2] no9([9, 19, 29, 3]) → [3] no9([1, 2, 3]) → [1,
	 * 2, 3]
	 */
	 ...
	 * 
	 * noTeen([12, 13, 19, 20]) → [12, 20] noTeen([1, 14, 1]) → [1, 1]
	 * noTeen([15]) → []
	 */
	 ...
	 * 
	 * noLong(["this", "not", "too", "long"]) → ["not", "too"] noLong(["a",
	 * "bbb", "cccc"]) → ["a", "bbb"] noLong(["cccc", "cccc", "cccc"]) → []
	 */
	 ...
	 * anywhere.
	 * 
	 * noYY(["a", "b", "c"]) → ["ay", "by", "cy"] noYY(["a", "b", "cy"]) →
	 * ["ay", "by"] noYY(["xx", "ya", "zz"]) → ["xxy", "yay", "zzy"]
	 */
