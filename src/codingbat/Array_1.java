...
public class Array_1 {
	 ...
	 * Reverse3
	 * 
	 * Reverse 3 Given an array of ints length 3, return a new array with the
	 ...
	 * length 1 or more.
	 *
	 * makeEnds({1, 2, 3}) -> {1, 3} makeEnds({1, 2, 3, 4}) -> {1, 4}
	 ...
	 *
	 * makeLast({4, 5, 6}) -> {0, 0, 0, 0, 0, 6} makeLast({1, 2}) -> {0, 0, 0,
	 * 2} makeLast({3}) -> {0, 3}
	 */
	 ...
	 *
	 * double23({2, 2}) -> true double23({3, 3}) -> true double23({2, 3}) ->
	 * false
	 */
	 ...
	 *
	 * makeMiddle({1, 2, 3, 4}) -> {2, 3} makeMiddle({7, 1, 2, 3, 4, 9}) -> {2,
	 * 3} makeMiddle({1, 2}) -> {1, 2}
	 */
	...
	public boolean unlucky1(int[] nums) {
		...
		if (nums.length >= 4) {
			return (nums[0] == 1 && nums[1] == 3) || (nums[nums.length - 2] == 1 && nums[nums.length - 1] == 3)
					|| (nums[1] == 1 && nums[2] == 3) || (nums[nums.length - 4] == 1 && nums[nums.length - 3] == 3);
		}
		return false;
	}
