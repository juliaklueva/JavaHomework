...
public class Warmup_1 {
	 ...
	 *
	 * sleepIn(false, false) -> true sleepIn(true, false) -> false
	...
	public String notString(String str) {
		...
		boolean hasNot = str.regionMatches(0, not, 0, 3);
		if (!hasNot) {
			return not + str;
		} else {
			return str;
	 ...
	 * cha added at the front and back, so "cat" yields "tcatt". The original
	 ...
	 *
	 * or35(3) -> true or35(10) -> true or35(3) -> true or35(10) -> true
	 */
	 ...
	 *
	 * front22("kitten") -> "kikittenki" front22("Ha") -> "HaHaHa"
	 * front22("abc") -> "ababcab"
	 */
	...
	public String front22(String str) {
		...
		if (str.length() < 2) {
			...
			more = str.substring(0, 2);
		}
		return more + str + more;
	}
	 ...
	 *
	 * hasTeen(13, 20, 10) -> true hasTeen(20, 19, 10) -> true hasTeen(20, 10,
	 * 13) -> true
	 */
	 ...
	 * unchanged.
	 *
	 * delDel("adelbc") -> "abc" delDel("adelHello") -> "aHello"
	 ...
	 *
	 * lastDigit(7, 17) -> true lastDigit(6, 17) -> false lastDigit(3, 113) ->
	 * true
	 */
