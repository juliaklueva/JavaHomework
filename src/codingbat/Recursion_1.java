...
public class Recursion_1 {
	 ...
	 * PowerN
	 *
	 * Given <b>base</b> and <b>n</b> that are both 1 or more, compute
	 * recursively (no loops) the value of base to the n power, so powerN(3, 2)
	 * is 9 (3 squared).
	 *
	 ...
	 *
	 * changePi("xpix") -> "x3.14x" changePi("pipi") -> "3.143.14"
	 * changePi("pip") -> "3.14p"
	 */
	 ...
	 *
	 * array11({1, 2, 11}, 0) -> 1 array11({11, 11}, 0) -> 2 array11({1, 2, 3,
	 * 4}, 0) -> 0
	 */
	 ...
	 *
	 * array220({1, 2, 20}, 0) -> true array220({3, 30}, 0) -> true
	 * array220({3}, 0) -> false
	 */
	 ...
	 *
	 * allStar("hello") -> "h*e*l*l*o" allStar("abc") -> "a*b*c" allStar("ab")
	 * -> "a*b"
	 */
	 ...
	 * StrCount
	 *
	 * Given a string and a non-empty substring <b>sub</b>, compute recursively
	 ...
	 *
	 * Given a string and a non-empty substring <b>sub</b>, compute recursively
	 * if at least n copies of sub appear in the string somewhere, possibly with
	 ...
	 *
	 * Given a string and a non-empty substring <b>sub</b>, compute recursively
	 * the largest substring which starts and ends with sub and return its
	 * length.
	 *
